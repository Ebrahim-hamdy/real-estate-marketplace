...
contract Ownable {
  ...
  function transferOwnership(address newOwner) public requireContractOwner {
...
contract Pausable is Ownable {
  ...
  function pause() public requireContractOwner requireNotPaused {
    _paused = true;
    emit Paused(msg.sender);
  }

  function unpause() public requireContractOwner requirePaused {
    _paused = false;
...
contract ERC721 is Pausable, ERC165 {
  ...
  function approve(address to, uint256 tokenId) public {
    ...
    require (to != ownerOf(tokenId), "Given address is the owner of the tokenId");
    // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
    require(msg.sender == ownerOf(tokenId) || isApprovedForAll(ownerOf(tokenId), msg.sender), "sender must be the owner of the contract");
  ...
  */
  ...
  function _transferFrom(address from, address to, uint256 tokenId) internal {
    ...
    require(from == ownerOf(tokenId), "From address is the owner of the given token");
...
contract EbraContract is ERC721Metadata (
    "Transfer Real Estate",
    "TRE",
    "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"
) {

    function mint(address to, uint256 tokenId) public requireContractOwner returns(bool) {
      super._mint(to, tokenId);
